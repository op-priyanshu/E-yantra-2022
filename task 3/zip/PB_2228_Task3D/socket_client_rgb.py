...
def rgb_led_setup(rgb):
	...
	##################	ADD YOUR CODE HERE	##################
	RED.start( int( rgb[0]/6.375 ) )
	GREEN.start( int( rgb[1]/3.863 ) )
	BLUE.start( int( rgb[2]/3.863 ) )
	##########################################################
	
def rgb_led_set_color(message,pwm_values):
	"""
	Purpose:
	---
	...
	rgb_led_setup(pwm_values[message])
...
if __name__ == "__main__":
		...
		pwm_values = {"Red": (255, 0, 0), "Blue": (0, 0, 255), "Green": (0, 255, 0), "Orange": (255, 12, 0), "Pink": (255, 0, 122), "Sky Blue": (0, 100, 100)}
		...
		while True:
			...
			if message == "STOP":
				...
				rgb_led_set_color(message,pwm_values)